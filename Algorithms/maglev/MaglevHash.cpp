...
#include <cstdlib>
#include <cstring>
#include "../../../../../../Downloads/cpp-consistent-hashing-algorithms-maglev/Algorithms/misc/HashFunctions.h"
#include "MaglevHash.hpp"
...
void MaglevHash::updatePermutation(){
    ...
    for(iter = workSet.begin(), i = 0; iter != workSet.end(); iter++, i++){
        ...
        permutationSkip[i] = crc32(*iter, permutationOffset[i]) % (M - 1) + 1;
    }
}
